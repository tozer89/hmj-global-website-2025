(function (root, factory) {
  ...
  function normaliseAssignmentRow(row = {}) {
    return {
      ...
      client_code: trimText(row.client_code, 120) || null,
      client_name: trimText(row.client_name, 240) || null,
      job_title: trimText(row.job_title, 240) || null,
      assignment_description: trimText(row.assignment_description, 240) || trimText(row.job_title, 240) || null,
      branch_name: trimText(row.branch_name || row.client_site, 240) || null,
      cost_centre: trimText(row.cost_centre, 120) || null,
      ir35_status: trimText(row.ir35_status, 80) || null,
      assigned_approvers: trimText(row.assigned_approvers, 4000) || null,
      assigned_contractors: trimText(row.assigned_contractors || row.candidate_name, 4000) || null,
      assignment_category: trimText(row.assignment_category, 160) || null,
      last_modified: trimText(row.last_modified, 80) || null,
