...
- `TSP_CLIENT_ID` — OAuth2 client ID for Brightwater TSP.
- `TSP_CLIENT_SECRET` — OAuth2 client secret for Brightwater TSP.
- `TSP_SCOPE` — OAuth2 scope string supplied by Brightwater.
