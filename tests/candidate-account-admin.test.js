...
test('rewriteAuthActionLink replaces loopback redirects with the canonical candidate route', () => {
  ...
  assert.equal(
    output,
    'https://mftwpbpwisxyaenfoizb.supabase.co/auth/v1/verify?token=abc123&type=recovery&redirect_to=https%3A%2F%2Fwww.hmj-global.com%2Fcandidates%3Fcandidate_action%3Drecovery'
  );
});
