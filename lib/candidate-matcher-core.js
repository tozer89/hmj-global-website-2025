...
const MATCH_ITEM_SCHEMA = buildClosedObjectSchema({
  ...
  matched_skills: buildStringArraySchema(8),
  matched_qualifications: buildStringArraySchema(6),
  transferable_experience: buildStringArraySchema(6),
  gaps: buildStringArraySchema(6),
  follow_up_questions: buildStringArraySchema(6),
...
const MATCH_RESULT_SCHEMA = {
  ...buildClosedObjectSchema({
    candidate_summary: buildClosedObjectSchema({
      ...
      sectors: buildStringArraySchema(6),
      locations: buildStringArraySchema(6),
      key_skills: buildStringArraySchema(10),
      key_qualifications: buildStringArraySchema(8),
      summary: { type: 'string' },
    }),
    top_matches: {
      type: 'array',
    ...
    general_follow_up_questions: buildStringArraySchema(),
...
function sanitiseMatch(match) {
  return {
    ...
    matched_skills: uniqueStrings(match?.matched_skills, 8),
    matched_qualifications: uniqueStrings(match?.matched_qualifications, 6),
    transferable_experience: uniqueStrings(match?.transferable_experience, 6),
    gaps: uniqueStrings(match?.gaps, 6),
    follow_up_questions: uniqueStrings(match?.follow_up_questions, 6),
...
function sanitiseAnalysisResult(result) {
  ...
  return {
    candidate_summary: {
      ...
      sectors: uniqueStrings(candidateSummary.sectors, 6),
      locations: uniqueStrings(candidateSummary.locations, 6),
      key_skills: uniqueStrings(candidateSummary.key_skills, 10),
      key_qualifications: uniqueStrings(candidateSummary.key_qualifications, 8),
