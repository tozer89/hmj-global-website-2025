...
function toCandidate(row = {}) {
  ...
  return {
    ...
    has_portal_account: !!(row.auth_user_id || row.authUserId),
    email: row.email || null,
    phone: row.phone || null,
    status: row.status || 'In progress',
    job_title: row.job_title || row.headline_role || row.role || null,
    ...
    onboarding_mode: normaliseBoolean(row.onboarding_mode ?? row.onboardingMode)
      || String(row.status || '').toLowerCase().trim() === 'invited',
    onboarding_status: row.onboarding_status || null,
    onboarding_status_updated_at: row.onboarding_status_updated_at || null,
    onboarding_status_updated_by: row.onboarding_status_updated_by || null,
    right_to_work_status: row.right_to_work_status || null,
    right_to_work_evidence_type: row.right_to_work_evidence_type || null,
    ...
    secondary_specialism: row.secondary_specialism || null,
    current_job_title: row.current_job_title || null,
    desired_roles: row.desired_roles || null,
    ...
    portal_account_closed_at: row.portal_account_closed_at || null,
    last_portal_login_at: row.last_portal_login_at || null,
    ...
    consent_captured: normaliseBoolean(row.consent_captured ?? row.terms_ok),
    consent_captured_at: row.consent_captured_at || null,
